...
function App() {
  ...
  return <div className="shell">
    <aside className="profile glass">
      <div className="avatar">NK</div><h1>Nithish Kumar P S</h1><p className="badge">AI Developer</p>
